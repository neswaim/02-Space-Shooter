...
var Enemy_Bullet1 = load("res://Enemy_Bullets/Enemy_Bullet1.tscn")
...
func _on_Shoot_timeout():
	if randf() < 0.2 and position.y > 0:
		var enemy_bullet1 = Enemy_Bullet1.instance()
		enemy_bullet1.position = position
		Bullets.add_child(enemy_bullet1)
